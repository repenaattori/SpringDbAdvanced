...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    //JPQL-formaatilla voidaan tehdä SQL-tyylisiä kyselyitä käyttäen olioita ja parametreja
    ...
    //Haetut sarakkeet talletetaan kustomoituun DTO-olioon.
    ...
    //Voidaan myös tehdä täysin natiiveja SQL-kyselyjä
